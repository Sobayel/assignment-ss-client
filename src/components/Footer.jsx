            ...
            <footer className="bg-white dark:bg-gray-900">
                <div className="container p-6 mx-auto">
                    <div className="lg:flex">
                        <div className="w-full -mx-6 lg:w-2/5">
                            <div className="px-6">
                                ...
                                <p className="text-xl font-semibold">Skill Up</p>
                        ...
                        <div className="mt-6 lg:mt-0 lg:flex-1">
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                ...
                                <div>
                                    ...
                                    <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">01581093144</span>
                                    <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">mdsobayelhossain@gmail.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <hr className="h-px my-6 bg-gray-200 border-none dark:bg-gray-700" />
                        ...
                        <div>
                            <p className="text-center text-gray-500 dark:text-gray-400">© Skill Up 2020 - All rights reserved</p>
                        </div>
                </div>
            </footer>
        </>
