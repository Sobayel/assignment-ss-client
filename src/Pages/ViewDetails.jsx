                    ...
                    {isOpen && <dialog id="my_modal_5" className="modal modal-bottom sm:modal-middle">
                        <form onSubmit={handlePdf} className="modal-box">
                            <div className="mt-3">
                                ...
                                <input type="link" placeholder="PDF/Doc" name="pdf" id="" className="block w-full px-4 py-2 mt-2 text-slate-700 rounded-sm bg-white border border-slate-300 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-30 focus:outline-none focus:ring" required />
                            </div>
                            <div>
                                <div className="mt-3">
                                    <label className="font-semibold text-xl"
